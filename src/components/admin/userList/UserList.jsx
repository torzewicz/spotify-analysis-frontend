                                ...
                                return (
                                    <TableRow key={user.id}>
                                        <TableCell style={{
                                            ...
                                            history.push(`/analysis/${user.username}`)
                                        }}>{user.username}</TableCell>
                                        <TableCell>{user.email}</TableCell>
                                        <TableCell>{user.role}</TableCell>
                                        <TableCell>{user.connectedToSpotify.toString()}</TableCell>
                                        ...
                                        <TableCell style={{display: 'flex', justifyContent: 'center'}}>
                                            <IconButton
                                                ...
                                                style={{color: user.enabled ? 'red' : 'green'}}>
                                                {user.enabled ? <ClearIcon/> : <CheckIcon/>}
                                            </IconButton>
                                        </TableCell>
                                    </TableRow>
                                )
